...
def nn_data(resolution: tuple, downsample: int) -> tuple:
    ...
    folder_path = f"/ptmp/mpa/dipda/subgrid/SubgridCGMModel/AthenaK_legacy/datafiles/nc{resolution}_{downsample}"
    file_path = f"/ptmp/mpa/dipda/subgrid/SubgridCGMModel/AthenaK_legacy/kh_build/src/nc{resolution[0]}_{resolution[1]}/bin"
...
if __name__ == "__main__":
    ...
    plt.savefig(
        f"log_loss_plots/cnn_{resolution}_{downsample}_loss.jpg",
        dpi=500
    )
