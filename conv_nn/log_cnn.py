...
def nn_data(resolution: tuple, downsample: int) -> tuple:
    ...
    folder_path = f"/ptmp/mpa/dipda/subgrid/SubgridCGMModel/AthenaK_legacy/datafiles/lc{resolution}_{downsample}"
    file_path = f"/ptmp/mpa/dipda/subgrid/SubgridCGMModel/AthenaK_legacy/kh_build/src/lc{resolution[0]}_{resolution[1]}/bin"
